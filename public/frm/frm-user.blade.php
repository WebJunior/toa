    ...
    <div class="frm">
        ...
        <div class="body">
            ...
            <div class="box">
                ...
                <div class="right">
                    <input type="email" class="form-control" id="first-name" name="first-name">
                </div>
            </div>
            <div class="box">
                <div class="left">
                ...
                <div class="right">
                    <input type="email" class="form-control" id="last-name" name="last-name">
                </div>
            </div>
            <div class="box">
                <div class="left">
            ...
            <div class="box">
                ...
                <div class="right">
                    <input type="email" class="form-control" id="date-join" name="date-join">
                </div>
            </div>
            <div class="box">
                <div class="left">
            ...
            <div class="box">
                ...
                <div class="right">
                    <input type="email" class="form-control" id="pass" name="pass">
                </div>
            </div>
            <div class="box">
                <div class="left">
            ...
            <div class="box">
                ...
                <div class="right">
                    <select class="form-select" id="check" name="check">
